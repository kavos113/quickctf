...
import (
	...
	_ "github.com/kavos113/quickctf/gen/api/server/v1"
	http "net/http"
)
...
const (
	...
	UserServiceName = "api.server.v1.UserService"
)
...
// UserServiceClient is a client for the api.server.v1.UserService service.
type UserServiceClient interface {
}

// NewUserServiceClient constructs a client for the api.server.v1.UserService service. By default,
// it uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses, and
// sends uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the connect.WithGRPC()
// or connect.WithGRPCWeb() options.
//
...
// UserServiceHandler is an implementation of the api.server.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	return "/api.server.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		default:
			http.NotFound(w, r)
		}
